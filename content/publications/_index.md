...
sections:
  ...
  - block: markdown
    content:
      title: 'Preprints'
      text: |
        1. Kyungjin Shin, et al. “A Comprehensive Analysis of Utility and Disclosure Risk Metrics for Synthetic Data,” *manuscript*.
  ...
  - block: markdown
    content:
      title: 'Software'
      text: |
        * R package [**"ClusTorus"**](https://CRAN.R-project.org/package=ClusTorus)
