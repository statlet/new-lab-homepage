...
<a href="/seminar/" style="color: #1e3a8a; text-decoration: none; font-weight: bold; font-size: 1.1rem;">← Back to Seminars</a>
</div>
...
<table class="seminar-table">
  <thead>
    <tr>
      ...
      <th style="width: 55%;">Materials</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td>성기헌, 김지우, 조성재</td>
      <td>
        <a href="여기에_링크를_넣으세요" target="_blank" style="color: #1e3a8a; text-decoration: underline; display: block; margin-bottom: 5px;">Seminar1_part_1.pdf</a>
        <a href="여기에_링크를_넣으세요" target="_blank" style="color: #1e3a8a; text-decoration: underline; display: block; margin-bottom: 5px;">Seminar1_part_2.pdf</a>
        <a href="여기에_링크를_넣으세요" target="_blank" style="color: #1e3a8a; text-decoration: underline; display: block;">Seminar1_part_3.pdf</a>
      </td>
    </tr>
  </tbody>
</table>
