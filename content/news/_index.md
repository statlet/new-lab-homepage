  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        <h2 style="margin: 0 0 10px 0; font-size: 2rem; color: #112240;">2026</h2>
        <hr style="border: 0; border-bottom: 2px solid #e5e7eb; margin-bottom: 30px; width: 100%;">
        <div style="line-height: 2; font-size: 1.05rem; color: #374151; margin-bottom: 50px;">
        ...
        <h2 style="margin: 0 0 10px 0; font-size: 2rem; color: #112240;">2025</h2>
        <hr style="border: 0; border-bottom: 2px solid #e5e7eb; margin-bottom: 30px; width: 100%;">
